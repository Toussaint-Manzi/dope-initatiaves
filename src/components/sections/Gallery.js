...
// import pic from '../../../public/assets/images/home/1.jpg'
...
const Gallery = () => {
  ...
  return (
    <div className='w-[70%] mx-auto mt-20 mb-48'>
        <div className=" mx-auto py-2 lg:px-16 xs:px-5">
            <div className='flex'>
                <h1 className={`grotesk mx-auto text-[#FF0054] text-3xl mb-24 font-[700]`} >Our work</h1>
            </div>
            <div className="-m-1 flex justify-between h-[600px] flex-wrap md:-m-2">
        ...
        <div className={selected ? 'fixed top-0 left-0 w-full h-full z-10 bg-dark':'hidden'}>
