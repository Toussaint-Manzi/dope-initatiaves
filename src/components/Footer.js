    ...
    >
      <div className={`flex flex-row justify-between xl:flex-col`}>
        <div className="xl:my-20">
          ...
          <h1 className="grotesk text-[25px] text-[#FF0054] font-[400]">
            (+250) 789294922
          </h1>
          <div className="flex flex-col my-10">
            <h1 className="roboto text-[18px] text-black font-[400]">
        ...
        <div className="flex xl:flex-col mt-5">
          <div className="flex w-[50%] justify-between xl:flex-col">
            <div>
              ...
              <ul className="h-full">
                <Link href="/">
                  <li className="text-md roboto text-black mb-1 cursor-pointer hover:text-[#FF0054] my-3">
                    Home
                  </li>
                </Link>
                <Link href="/About">
          ...
          <div className="border border-[#eed3c9] w-[70%] xs:w-full flex flex-col items-center justify-between py-8 px-10 xl:my-20">
            <h1 className="roboto text-lg font-medium text-black text-center">
              Stay up to date and subscribe to our newsletter
            </h1>
            <div className="w-[150px] h-[150px]">
              {LottieComp ? (
                <LottieComp animationData={messageAnimation} />
              ) : null}
            </div>
            ...
            <Link
              href="#section1"
              className="h-[40px] bg-white border-[3px] border-[#FF0054] rounded-md flex items-center justify-center text-[#FF0054] mt-16 hover:bg-[#FF0054] hover:text-white px-10 py-6"
            >
      ...
      <div className="h-[1px] w-full bg-[#eed3c9] mt-20"></div>
      <div className="mt-10 w-full flex justify-between items-center xl:flex-col">
        <p className="text-gray-500">
          Dope initiatives © {new Date().getFullYear()} All rights reserved
        </p>
        <div className="flex justify-between w-[20%] xl:w-[35%] my-5 xs:w-[60%]">
          <Link
            href="https://www.instagram.com/dope_initiatives/"
            target="_blank"
            className="w-[45px] h-[45px] xs:w-[40px] xs:h-[40px] bg-orange-500 rounded-full flex justify-center items-center cursor-pointer hover:bg-amber-500 hover:transition-all hover:duration-300"
          >
            <AiFillInstagram className="text-white text-xl" />
          </Link>
          <Link
            href="https://x.com/Dope_Initiative"
            target="_blank"
            className="w-[45px] h-[45px] xs:w-[40px] xs:h-[40px] bg-orange-500 rounded-full flex justify-center items-center cursor-pointer hover:bg-amber-500 hover:transition-all hover:duration-300"
          >
            <svg
          ...
          <Link
            href="https://www.linkedin.com/company/dopeinitiatives"
            target="_blank"
            className="w-[45px] h-[45px] xs:w-[40px] xs:h-[40px] bg-orange-500 rounded-full flex justify-center items-center cursor-pointer hover:bg-amber-500 hover:transition-all hover:duration-300"
          >
