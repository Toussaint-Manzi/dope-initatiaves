...
const About = () => {
  ...
  return (
    <div className='h-full pb-[200px] bg-[#F9F0EC] w-full px-[10%] pt-[200px] flex justify-between items-center 2xl:h-full xl:py-[150px]'>
      ...
      <div className='w-[45%] self-start xl:w-full'>
        <h1 className='roboto text-[32px] text-[#FF0054] font-semibold xs:text-[25px]'>Who we are</h1>
        <h1 className='text-[25px] text-black font-[600] grotesk  my-6 xs:text-[20px]'>Dope Initiatives is a young-led social enterprise committed to revolutionizing sexual reproductive health education in a fun way. Additionally, we are contributing to the end of period poverty by distributing free and sustainable sanitary pads in secondary schools using the Keza Pad Bank, a sanitary pad vending machine.</h1>
        {showMore && (
          <>
        ...
        <button
          className='mt-4 text-[#FF0054] grotesk text-[17px] font-medium hover:underline'
